...
const pessoasRef = ref(db, "alpha_pessoas");
...
document.getElementById("formMDO").addEventListener("submit", (e) => {
  ...
  update(ref(db, "alpha_pessoas/" + id), {
...
window.salvarEdicao = function () {
  ...
  update(ref(db, "alpha_pessoas/" + editandoID), {
...
window.deletarPessoa = function (id,nome) {
  ...
  remove(ref(db, "alpha_pessoas/" + id));
...
window.exportarPDF = function(){
  ...
  doc.setFontSize(18);
  doc.text("RELATÓRIO ALPHA",20,10);
